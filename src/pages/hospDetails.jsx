...
const HospDetails = () => {
  ...
  if (!hospital) return <p className="text-center text-red-500">No hospital data found.</p>;
    ...
    <div>
      <div className="flex flex-wrap md:flex-nowrap items-center mb-2">
        ...
        <div className="flex flex-col ml-3">
          <h1 className="font-bold text-2xl md:text-3xl">{hospital.hospitalName}</h1>
      ...
      <p className="text-gray-700 text-sm md:text-base"> Doctors | Multi-Speciality Hospital</p>
  ...
  <div className="w-full md:w-1/2 mt-4 md:mt-0">
    ...
    <div className="max-w-7xl container mx-auto px-4 py-8">
      ...
      <p className="mb-6 text-gray-600">
        ...
        <Insurances/>
        <div className="m-5 pt-5 text-3xl font-bold">Docter List</div>
        <div className="bg-white rounded-2xl shadow-lg p-4 flex items-center space-x-4 w-full max-w-lg">
        <img
         src={hospital.image || "https://via.placeholder.com/50"}
         alt="Doctor"
        ...
        <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm truncate">
                <strong>degree:</strong> {hospital.degree}
            </p>
            <p className="text-gray-600 text-sm">
                <strong>Experience:</strong> {hospital.experience} Years
            </p>
            <p className="text-gray-600 text-sm truncate">
                <strong>prices:</strong> {hospital.prices}
            </p>
        </div>
        <Link
