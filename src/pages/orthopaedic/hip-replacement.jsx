    ...
    return (
        <>
            ...
            <div>
                ...
                <ul className='mb-2 list-disc ml-3'>
                    <li className='mb-2'>Persistent hip pain, even at rest. </li>
                    <li className='mb-2'>Limited range of motion in the hip joint</li>
                    <li className='mb-2'>Difficulty in walking or bearing weight on the affected hip</li>
                    <li className='mb-2'>Chronic hip stiffness</li>
                    <li className='mb-2'>Little to no improvement with non-surgical treatments, such as physical therapy or pain medications. </li>
                </ul>
